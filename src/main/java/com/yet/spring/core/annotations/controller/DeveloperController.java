package com.yet.spring.core.annotations.controller;


import com.yet.spring.core.annotations.beans.Developer;
...
public class DeveloperController {
    ...
    public String addStudent(@ModelAttribute("spring-mvc-dispatcher") Developer developer,
                             ModelMap model) {
